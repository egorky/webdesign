        ...
        <div className="bg-background-light min-h-screen pt-32 pb-24">
            <div className="max-w-4xl mx-auto px-6">
                <div className="bg-white border-4 border-black p-12 shadow-[16px_16px_0px_0px_rgba(0,0,0,1)]">
                    <h1 className="text-5xl font-black mb-6 uppercase tracking-tighter">{t('legal.terms.title')}</h1>
                    <p className="text-xs font-black uppercase tracking-widest text-primary mb-10">{t('legal.terms.lastUpdated')}</p>

            ...
            <main className="max-w-7xl mx-auto px-6 py-24">
                <div className="mb-20">
                    <h2 className="font-display text-4xl lg:text-5xl font-black mb-6 tracking-tight text-darkBlue uppercase">
                        {t('industryPages.banking.useCasesTitle')}
                    </h2>
                            ...
                            <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                                {useCase.image ? (
                                    <div className="bg-white b-solid p-4 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                                        <img src={useCase.image} alt={useCase.title} className="w-full h-auto" />
                                    </div>
                                ) : (
                                    <div className="bg-yellow-50 b-solid p-12 aspect-video flex items-center justify-center shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                                        <span className="material-symbols-outlined text-9xl text-yellow-600/30">account_balance</span>
                                    </div>
                                )}
                            </div>
                        </div>
                ...
                <section className="mt-40 bg-darkBlue p-12 md:p-24 text-center text-white relative overflow-hidden border-4 border-black shadow-[20px_20px_0px_0px_rgba(255,255,255,1),20px_20px_0px_4px_rgba(0,0,0,1)]">
                    <div className="relative z-10">
                        ...
                        <Link to="/contact" className="inline-block bg-primary text-white px-12 py-6 border-4 border-black font-black uppercase text-lg tracking-tighter shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] hover:-translate-y-1 hover:shadow-[12px_12px_0px_0px_rgba(255,255,255,1)] transition-all">
